...
{
	?>
	<form id="frm_system_status" class="layout-form wpcb-page-width" method="post">
			...
			<div class="layout-span12 responsive">
				<div class="widget-layout ">
					...
					<div class="widget-layout-body">
						<a class="btn btn-success system-report" href="#"><?php _e("Get System Report", captcha_bank); ?></a>
						<div id="wp-insta-system-report" class="layout-system-report">
							<textarea readonly="readonly"></textarea>
						</div>
						<a class="btn btn-success close-report" style="display:none;" href="#"><?php _e("Close System Report", captcha_bank); ?></a>
						<div class="separator-doubled"></div>
						<div class="fluid-layout">
							<div class="layout-span6 responsive">
								<div class="widget-layout">
									<div class="widget-layout-title">
										<h4><?php _e("Environment", captcha_bank); ?></h4>
									</div>
									<div class="widget-layout-body">
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Home URL :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php echo home_url(); ?>
												</span>
											</div>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("WP Version :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("WP Multisite Enabled :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php if (is_multisite()) echo  _e("Yes", captcha_bank); else echo  _e("No", captcha_bank); ?>
												</span>
											</div>
										</div>
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Web Server Info :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Version :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("MySQL Version :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php 
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("WP Debug Mode :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php if (defined("WP_DEBUG") && WP_DEBUG) echo _e("Yes", captcha_bank); else echo _e("No", captcha_bank); ?>
												</span>
											</div>
										</div>
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("WP Language :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php if (defined("WPLANG") && WPLANG) echo WPLANG; else echo _e("Default", captcha_bank); ?>
												</span>
											</div>
										</div>
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Post Max Size :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php 
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("WP Max Upload Size :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											...
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													...
													{
														echo _e("Success", captcha_bank);
													}
													else
													{
														echo _e("Failed", captcha_bank);
													}
													?>
												</span>
											</div>
									...
									<?php if (function_exists("ini_get")) : ?>
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Max Script Execute Time", captcha_bank); ?> :
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Max Input Vars :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("SUHOSIN Installed :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
									...
									<?php endif; ?>
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Default Timezone :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php
									...
									?>
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Operating System :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Memory usage :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Safe Mode :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Allow URL fopen :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Memory Limit :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Max Post Size :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PCRE Backtracking Limit :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP Exif support :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php echo $exif; ?>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP IPTC support :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php echo $iptc; ?>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("PHP XML support :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php echo $xml; ?>
							...
							<div class="layout-span6 responsive">
								<div class="widget-layout">
									...
									<div class="widget-layout-body">
										<div class="layout-control-group">
											<label class="layout-control-label">
											 	<?php _e("Installed Plugins :", captcha_bank); ?>
											 </label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php
													...
													foreach ($active_plugins as $plugin) {
														...
														if (!empty($plugin_data["Name"])) 
														{
															...
															if (strstr($dirname, captcha_bank)) {
								...
								<div class="widget-layout">
									...
									<div class="widget-layout-body">
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Theme Name :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Theme Version :", captcha_bank); ?>
											</label>
												<div class="layout-controls wpcb-custom-layout-control">
												<span>
												<?php
										...
										<div class="layout-control-group">
											<label class="layout-control-label">
												<?php _e("Author URL :", captcha_bank); ?>
											</label>
											<div class="layout-controls wpcb-custom-layout-control">
												<span>
													<?php echo $active_theme->{"Author URI"}; ?>
												</span>
											</div>
										</div>
									</div>
