<div class="block well" >
	<div class="navbar">
		<div class="navbar-inner">
			<h5><?php _e( "Captcha Bank - Documentation", captcha_bank ); ?></h5>
		</div>
	</div>
				...
				<form id="captcha_documentation" class="form-horizontal" method="post">
					<div class="row-fluid">
						<div class="span8">
							<div class="block well">
								<div class="body">
									<iframe width="765" height="320" src="//www.youtube.com/embed/jxq9_f7uYfM" frameborder="0" allowfullscreen></iframe>
								</div>
							</div>
						</div>
						<div class="span4">
